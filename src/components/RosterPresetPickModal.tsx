...
const PRESET_LABEL_MAP: Record<string, string> = {
  ...
  three_clusters_line: "3密集（左中右）",
  three_clusters_front: "3密集（前列）",
  wing_spread: "翼形",
  cross_split: "十字グループ",
  split_lr_cluster: "2分割・左右密集",
  split_lr_line: "2分割・左右縦列",
  split_lr_two_rows: "2分割・左右2列",
  split_lr_front: "2分割・左右手前",
  split_lr_back: "2分割・左右奥",
  split_lr_corridor: "2分割・中央通路",
  split_fb_cluster: "2分割・前後密集",
  split_fb_line: "2分割・前後横列",
  split_diag_lr: "2分割・斜め＼／",
  split_diag_rl: "2分割・斜め／＼",
  split_lr_stagger: "2分割・左右千鳥",
  split_lr_arc: "2分割・左右弧",
  diamond: "ひし形周り",
  extra_pyramid_narrow: "ピラミッド（狭）",
  extra_pyramid_wide: "ピラミッド（広）",
  extra_pyramid_deep: "ピラミッド（深）",
  w_shape: "W字形",
  w_shape_wide: "W字形（広）",
  w_shape_deep: "W字形（深）",
  m_shape: "M字形",
  ...
  front_stair_from_2: "２段",
  front_stair_from_3: "３段",
  front_stair_from_4: "４段",
  waist_stair_from_3: "３段（中細）",
  waist_stair_from_4: "４段（中細）",
  waist_stair_from_5: "５段（中細）",
