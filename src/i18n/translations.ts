...
const EN_BASE: MessageBundle = {
  ...
  "auth.registerBlurb":
    "Sign up with Google, Apple, phone, other social accounts, or email and password.",
  ...
  "auth.quickSignInHeading": "Sign in with Google, Apple, or other services",
  "auth.continueGoogle": "Continue with Google",
  "auth.continueApple": "Continue with Apple",
  "auth.continueGithub": "Continue with GitHub",
  "auth.continueFacebook": "Continue with Facebook",
  "auth.continueTwitter": "Continue with X (Twitter)",
  "auth.phoneHeading": "Or use your phone number",
  "auth.phoneLabel": "Mobile number",
  "auth.phonePlaceholder": "09012345678 or +819012345678",
  "auth.phoneHint":
    "SMS verification requires Phone auth enabled in Supabase (Twilio etc.). Japan numbers: enter without leading 0 or use +81.",
  "auth.sendOtp": "Send verification code",
  "auth.verifyOtp": "Verify and sign in",
  "auth.otpLabel": "Verification code",
  "auth.otpPlaceholder": "6-digit code",
  "auth.changePhone": "Use a different number",
  "auth.phoneWorking": "Please wait…",
  "auth.phoneRequired": "Enter your phone number.",
  "auth.otpRequired": "Enter the verification code from SMS.",
  "auth.phoneOtpSendFailed": "Could not send SMS. Check Supabase Phone provider settings.",
  "auth.phoneOtpVerifyFailed": "Invalid or expired code. Try again.",
  "auth.socialLoginFailed": "Social sign-in failed. Check provider settings in Supabase.",
...
const BASE_TRANSLATIONS: Record<AppLocale, MessageBundle> = {
  ja: {
    ...
    "auth.registerBlurb":
      "Google・Apple・携帯電話・その他SNS、またはメールとパスワードでアカウントを作成できます。",
    ...
    "auth.quickSignInHeading": "Google・Apple・その他のSNSでログイン",
    "auth.continueGoogle": "Google で続ける",
    "auth.continueApple": "Apple ID で続ける",
    "auth.continueGithub": "GitHub で続ける",
    "auth.continueFacebook": "Facebook で続ける",
    "auth.continueTwitter": "X（Twitter）で続ける",
    "auth.phoneHeading": "または携帯電話番号で",
    "auth.phoneLabel": "携帯電話番号",
    "auth.phonePlaceholder": "09012345678 または +819012345678",
    "auth.phoneHint":
      "SMS 認証には Supabase で Phone プロバイダ（Twilio 等）の設定が必要です。国内番号は先頭 0 を除くか +81 形式で入力してください。",
    "auth.sendOtp": "認証コードを送信",
    "auth.verifyOtp": "認証してログイン",
    "auth.otpLabel": "認証コード",
    "auth.otpPlaceholder": "6桁のコード",
    "auth.changePhone": "別の番号を使う",
    "auth.phoneWorking": "処理中…",
    "auth.phoneRequired": "携帯電話番号を入力してください。",
    "auth.otpRequired": "SMS の認証コードを入力してください。",
    "auth.phoneOtpSendFailed": "SMS を送信できませんでした。Supabase の Phone 設定を確認してください。",
    "auth.phoneOtpVerifyFailed": "コードが無効または期限切れです。もう一度お試しください。",
    "auth.socialLoginFailed": "ソーシャルログインに失敗しました。Supabase のプロバイダ設定を確認してください。",
  ...
  ko: {
    ...
    "auth.registerBlurb":
      "Google·Apple·휴대전화·기타 SNS 또는 이메일과 비밀번호로 계정을 만들 수 있습니다.",
    ...
    "auth.quickSignInHeading": "Google·Apple·기타 SNS로 로그인",
    "auth.continueGoogle": "Google로 계속",
    "auth.continueApple": "Apple ID로 계속",
    "auth.continueGithub": "GitHub로 계속",
    "auth.continueFacebook": "Facebook으로 계속",
    "auth.continueTwitter": "X(Twitter)로 계속",
    "auth.phoneHeading": "또는 휴대전화 번호로",
    "auth.phoneLabel": "휴대전화 번호",
    "auth.phonePlaceholder": "01012345678 또는 +821012345678",
    "auth.phoneHint":
      "SMS 인증은 Supabase Phone 프로바이더(Twilio 등) 설정이 필요합니다.",
    "auth.sendOtp": "인증 코드 보내기",
    "auth.verifyOtp": "인증 후 로그인",
    "auth.otpLabel": "인증 코드",
    "auth.otpPlaceholder": "6자리 코드",
    "auth.changePhone": "다른 번호 사용",
    "auth.phoneWorking": "처리 중…",
    "auth.phoneRequired": "휴대전화 번호를 입력하세요.",
    "auth.otpRequired": "SMS 인증 코드를 입력하세요.",
    "auth.phoneOtpSendFailed": "SMS를 보낼 수 없습니다. Supabase Phone 설정을 확인하세요.",
    "auth.phoneOtpVerifyFailed": "코드가 잘못되었거나 만료되었습니다.",
    "auth.socialLoginFailed": "소셜 로그인에 실패했습니다. Supabase 프로바이더 설정을 확인하세요.",
  ...
  zh: {
    ...
    "auth.registerBlurb":
      "可使用 Google、Apple、手机号、其他社交账号或邮箱密码注册。",
    ...
    "auth.toLibrary": "资料库",
    "auth.quickSignInHeading": "使用 Google、Apple 或其他社交账号登录",
    "auth.continueGoogle": "使用 Google 继续",
    "auth.continueApple": "使用 Apple ID 继续",
    "auth.continueGithub": "使用 GitHub 继续",
    "auth.continueFacebook": "使用 Facebook 继续",
    "auth.continueTwitter": "使用 X（Twitter）继续",
    "auth.phoneHeading": "或使用手机号",
    "auth.phoneLabel": "手机号码",
    "auth.phonePlaceholder": "13800138000 或 +8613800138000",
    "auth.phoneHint": "短信验证需在 Supabase 中启用 Phone 提供商（如 Twilio）。",
    "auth.sendOtp": "发送验证码",
    "auth.verifyOtp": "验证并登录",
    "auth.otpLabel": "验证码",
    "auth.otpPlaceholder": "6 位验证码",
    "auth.changePhone": "更换号码",
    "auth.phoneWorking": "处理中…",
    "auth.phoneRequired": "请输入手机号码。",
    "auth.otpRequired": "请输入短信验证码。",
    "auth.phoneOtpSendFailed": "无法发送短信，请检查 Supabase Phone 设置。",
    "auth.phoneOtpVerifyFailed": "验证码无效或已过期。",
    "auth.socialLoginFailed": "社交登录失败，请检查 Supabase 提供商设置。",
