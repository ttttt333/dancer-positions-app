...
const EN_BASE: MessageBundle = {
  ...
  "landing.headline": "Zero position mistakes. Faster formations.",
  "landing.support":
  ...
  "landing.reason.02": "Eliminate position mistakes",
...
const BASE_TRANSLATIONS: Record<AppLocale, MessageBundle> = {
  ja: {
    ...
    "landing.headline": "立ち位置ミスをゼロへ。作成は圧倒的に速く。",
    "landing.support":
    ...
    "landing.reason.03": "フォーメーション作成が速い",
    "landing.reason.04": "スマホ・タブレットで確認",
    "landing.reason.05": "メンバー全員にすぐ共有",
