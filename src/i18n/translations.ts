...
const EN_BASE: MessageBundle = {
  ...
  "landing.headline": "Formations that stay with the music",
  "landing.support":
    "Build stage positions on a timeline, share a viewer link with your dancers, and keep every cue in sync.",
  "landing.ctaTry": "Try for free",
  "landing.ctaRegister": "Create account",
    "landing.reasonsTitle": "Why CHOREO CORE",
    "landing.reasonsLead":
      "Choose templates, build with confidence, and share immediately with your team.",
    "landing.registerMethodsHint": "Register with email or Google.",
    "landing.reason.01": "Pick from a rich set of templates and start editing instantly.",
    "landing.reason.02": "Eliminate position mistakes with guidance that stays on track.",
    "landing.reason.03": "Create formations dramatically faster.",
    "landing.reason.04": "Review anytime on your smartphone or tablet.",
    "landing.reason.05": "Share with the whole team right away.",
    "landing.reason.06": "Manage positions in sync with the music.",
    "landing.reason.07": "Updates and changes reflect in seconds.",
    "landing.reason.08": "Shorten rehearsal time and increase dance time.",
    "landing.reason.09": "Free yourself from the stress of memorizing positions.",
    "landing.reason.10": "Improve the quality of contests and performances.",
    "landing.reason.11": "No more paper or image management for saving data.",
...
const BASE_TRANSLATIONS: Record<AppLocale, MessageBundle> = {
  ja: {
    ...
    "landing.headline": "楽曲と立ち位置を、そのまま同期",
    "landing.support":
      "タイムライン上でフォーメーションを組み、生徒には閲覧リンクを共有。キューごとに立ち位置を揃えられます。",
    "landing.ctaTry": "無料で始める",
    "landing.ctaRegister": "アカウント作成",
    "landing.reasonsTitle": "CHOREO COREを使う理由",
    "landing.reasonsLead":
      "雛形から選んで安心して作り、チーム全員にすぐ共有できます。",
    "landing.registerMethodsHint": "登録はメアド（パスワード）または Google でできます。",
    "landing.reason.01": "豊富な雛形から選んで、すぐに配置・修正が可能。",
    "landing.reason.02": "立ち位置ミスをゼロへ。",
    "landing.reason.03": "フォーメーション作成が圧倒的に速い。",
    "landing.reason.04": "スマホ・タブレットでいつでも確認。",
    "landing.reason.05": "メンバー全員にすぐ共有できる。",
    "landing.reason.06": "音楽に合わせて立ち位置を管理。",
    "landing.reason.07": "修正・変更も数秒で反映。",
    "landing.reason.08": "リハーサル時間を短縮し、踊る時間を増やせる。",
    "landing.reason.09": "立ち位置を覚えるストレスから解放。",
    "landing.reason.10": "コンテスト・発表会の完成度が上がる。",
    "landing.reason.11": "データ保存で紙や画像管理はもう不要。",
