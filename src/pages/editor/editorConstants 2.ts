...
export const EDITOR_WIDE_MIN_PX = 1024;
...
/** 上部波形ドック行の既定高さ（px） */
export const TOP_DOCK_HEIGHT_PX = 62;

/** ワイド＋上部波形時の固定シェル：波形行の外枠高さのベース（px） */
export const EDITOR_SHELL_TOP_WAVE_BASE_PX = 110;
...
export const TOP_DOCK_ROW_MIN_PX = 60;
