...
/** 波形ダブルクリック／ダブルタップで作るキューの初期長（秒） */
export const WAVE_DOUBLE_CLICK_CUE_SPAN_SEC = 10;

/** @deprecated `WAVE_DOUBLE_CLICK_CUE_SPAN_SEC` を使用 */
export const MOBILE_WAVE_DOUBLE_TAP_CUE_SPAN_SEC = WAVE_DOUBLE_CLICK_CUE_SPAN_SEC;
